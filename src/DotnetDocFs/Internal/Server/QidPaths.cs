...
/// <summary>
/// Hands each node of the catalog a qid path and keeps handing it the same one.
/// </summary>
/// <remarks>
/// A qid is how a 9P client tells two files apart and how it decides whether what it cached is
/// still the file it walked to. The catalog builds its nodes lazily, so the same page can be a
